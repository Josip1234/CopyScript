 ...
 * 
 * @author Korisnik
 * @category <b>Messages</b>
 * @version 1.0
 * CLass for messages display
 * every message will be visible to all classes 
 * marked as public
 */
public class Message {
public static final String mainFolders="Main folder menu";
public static final String menuItem="Choose menu item:";
public static final String folderOperations="1.Folder operations";
